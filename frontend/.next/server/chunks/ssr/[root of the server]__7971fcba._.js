...
"[project]/src/components/Terminal.tsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/src/components/Terminal.tsx'
...
function Home() {
    ...
    const handleRunCode = async ()=>{
        ...
        try {
            ...
            if (data.status === 'success') {
                ...
                setOutput(`Error: ${data.error_message || 'Unknown error'}`);
            }
        } catch (error) {
    ...
    const handleTerminalCommand = async (command)=>{
        ...
        // Here you would handle the command, but for now we'll just echo it
        setOutput((prev)=>prev + `$ ${command}\n`);
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7971fcba._.js.map